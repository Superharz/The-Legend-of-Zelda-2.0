...
public final class ReadWriteTextFileWithEncoding {
    ...
    /**
     * Sorts the LinkedList created by the read() method It sorts it after the
     * amount of shoots the player needed From small to big Calls the write()
     * method to rewrite the sorted text file
     */
    private void sort() {
        try {
